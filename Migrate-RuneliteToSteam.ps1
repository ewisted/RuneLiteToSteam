...
switch ($PSCmdlet.ParameterSetName)
{
    ...
    "Schedule"
    {
        ...
        {
            $actionArgs = "-NoProfile -ExecutionPolicy Bypass -File `"$($MyInvocation.MyCommand.Path)`" -RuneLiteInstallPath `"$RuneLiteInstallPath`" -SteamClientInstallPath `"$SteamClientInstallPath`""
